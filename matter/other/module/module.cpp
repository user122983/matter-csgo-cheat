...
module_info::module_info( const std::size_t the_module ) {
...
address module_info::find_pattern( const std::string_view pattern ) const {
	...
	const auto bytes = new int[ pattern.size( ) / 2 ];
...
address module_info::search_byte_array( int* bytes, const std::size_t size ) const {
