...
bool modules::get( ) {
	...
	m_vstdlib_dll = m_pe.get( "vstdlib.dll" );
...
void modules::get_addresses( ) {
	...
	m_client_dll.add_address( "C_CSPlayer::HasC4", "56 8B F1 85 F6 74 31 8B 06 8B 80 ? ? ? ? FF D0 84 C0 74 ?" );
	...
	m_client_dll.add_address( "ClientModeShared::OverrideView", "55 8B EC 83 E4 F8 83 EC 58 56 57 8B 3D ? ? ? ?" );
